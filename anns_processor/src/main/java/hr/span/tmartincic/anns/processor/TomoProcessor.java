package hr.span.tmartincic.anns;
...
public class TomoProcessor extends AbstractProcessor
{
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv)
    {
        ...
        builder.append("package hr.span.tmartincic.annotations.generated;\n");
        builder.append("\n");
        ...
        try {
            JavaFileObject sourceFile = filer.createSourceFile("hr.span.tmartincic.annotation_demo.generated.GeneratedFromTomo");
