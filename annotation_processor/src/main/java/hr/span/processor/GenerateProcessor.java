...
public class GenerateProcessor extends AbstractProcessor
{
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv)
    {
        ...
        builder.append("package hr.span.tmartincic.annotation_demo.generated;\n");
        builder.append("\n");
        ...
        try
        {
            JavaFileObject jfo = filer.createSourceFile("hr.span.tmartincic.annotation_demo.generated.GeneratedClass");
