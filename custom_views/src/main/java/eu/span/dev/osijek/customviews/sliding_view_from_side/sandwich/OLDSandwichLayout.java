...
// *
// *  Children are supplied via the {@link R.attr#bottomChild} and {@link R.attr#topChild} attributes
...
// */
//public class OLDSandwichLayout extends RelativeLayout
//{
//    private static final String tag = "CustomViews";
//
//    /** Global context */
//    private final ViewGroup me;
//    private View.OnTouchListener bottomChildTouchListener;
//    private View.OnTouchListener topChildTouchListener;
//    private OLDObjectAnimatorPostman animator;
//
//    /**
...
//
//    /**
//     *  Default value for {@link R.attr#bottomChild} and {@link R.attr#topChild} in case they
...
//
//    /**
//     *  Constant used to tweak the {@link OLDSandwichLayout#animationEndValueToLeft}
//     */
//    private static final float animationStartOffsetPercentage = 0.0F;
//
//    /**
//     *  Constant used to tweak the {@link OLDSandwichLayout#animationEndValueToRight}
//     */
...
//
//    public OLDSandwichLayout(Context context, AttributeSet attrs)
//    {
//        super(context, attrs);
//
//        me = this;
//
//        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.OLDSandwichLayout);
...
//        }
//
//        this.addView(inflatedBottomChild);
//        this.addView(inflatedTopChild);
//
//        initialize(context);
//        array.recycle();
//    }
...
//    }
//
//    private View.OnTouchListener getBottomChildTouchListener()
//    {
...
//    }
//
//    private View.OnTouchListener getTopChildTouchListener()
//    {
//        if(topChildTouchListener == null)
//        {
//            topChildTouchListener = new View.OnTouchListener()
//            {
//                @Override
//                public boolean onTouch(View v, MotionEvent ev)
//                {
...
//
//
//    private OLDObjectAnimatorPostman getPostman()
//    {
//        if(animator ==  null)
//        {
//            animator = new OLDObjectAnimatorPostman()
//            {
//                @Override
...
//        {
//            throw new RuntimeException(this.getClass().getSimpleName() + " does not support XML defined children." +
//                    " Add the layouts via bottomChild and topChild attributes");
//        }
//
